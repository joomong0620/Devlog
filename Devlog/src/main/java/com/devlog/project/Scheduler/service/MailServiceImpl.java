	...
	private String buildHot3Html(List<Hot3DTO> list) {
	    ...
	    for (Hot3DTO dto : list) {
	        ...
	        sb.append("<a href=\"")
	          ...
	          .append("\" style=\"display:inline-block; padding:6px 14px; background:#6b4eff; color:white; border-radius:16px; text-decoration:none; font-size:13px;\">Devlog 이동 →</a>");
	    ...
	    sb.append("<a href=\"localhost:8880")
